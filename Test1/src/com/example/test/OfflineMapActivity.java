...
public class OfflineMapActivity extends Activity implements
	...
	MapView mapView=MainActivity.mMapView;
	private String[] name=new String[]{province+cityname};
	private String[] descs=new String[]{"(当前城市)"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SimpleAdapter simpleAdapter=new SimpleAdapter(this, listItems, R.layout.download1,
	...
	private void init() {
		...
		provinceList = amapManager.getOfflineMapProvinceList();//获得城市列表
